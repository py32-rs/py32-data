...
impl From<mcufinder::File> for py32_data_serde::chip::Doc {
...
pub struct AllMcuFiles(HashMap<String, py32_data_serde::chip::Doc>);
...
impl Docs {
    ...
    pub fn documents_for(&self, chip_name: &str) -> Vec<py32_data_serde::chip::Doc> {
