...
use chiptool::ir::IR;
use py32_data_serde::chip::core::peripheral::rcc::{Field, StopMode};
use py32_data_serde::chip::core::peripheral::{self, rcc};
...
impl ParsedRccs {
    ...
    pub fn match_peri_clock(
        ...
        rcc_version: &str,
        peri_name: &str,
    ) -> Option<py32_data_serde::chip::core::peripheral::Rcc> {
