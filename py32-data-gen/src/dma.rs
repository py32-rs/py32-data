...
pub struct ChipDma {
    pub peripherals: HashMap<String, Vec<py32_data_serde::chip::core::peripheral::DmaChannel>>,
    pub channels: Vec<py32_data_serde::chip::core::DmaChannels>,
}
                ...
                if channels.len() == 1 {
                        ...
                        if req_dmamux == dmamux {
                            for (request_name, request_num) in y {
                                ...
                                chip_dma
                                    ...
                                    .or_default()
                                    .push(py32_data_serde::chip::core::peripheral::DmaChannel {
                    ...
                    for n in dma_peri_name.split(',') {
                        ...
                        if let Some(result) = re.captures(&channels[0].name) {
                            ...
                            for i in low..=high {
                                chip_dma.channels.push(py32_data_serde::chip::core::DmaChannels {
                                    name: format!("{n}_CH{i}"),
                                    dma: n.to_string(),
                        ...
                        for target in channel.mode_logic_operator.unwrap().modes {
                            ...
                            if target_name != "MEMTOMEM" {
                                ...
                                for request in target_requests {
                                    ...
                                    let entry = py32_data_serde::chip::core::peripheral::DmaChannel {
                                        signal: request.to_string(),
